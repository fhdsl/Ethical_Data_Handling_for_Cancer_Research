...
<img src="resources/images/01-intro_files/figure-html//1SRokLaGAc2hiwJSN26FHE0ZEEhPr3KQdyMICic8kAcs_p.png" title="Ethical Data Handling for Cancer Research. Written by: Carrie Wright. Contributed and Edited by: Candace Savonen and Jeff Leek" alt="Ethical Data Handling for Cancer Research. Written by: Carrie Wright. Contributed and Edited by: Candace Savonen and Jeff Leek" width="100%" style="display: block; margin: auto;" />
...
<img src="resources/images/01-intro_files/figure-html//1SRokLaGAc2hiwJSN26FHE0ZEEhPr3KQdyMICic8kAcs_g256827a0886_0_0.png" title="This courses is itended for anyone who needs a refresher on ethical data handling, Is new working with new data (esp. clinical or genomic data) and wants to use it appropriately, wants to learn about the emerging and current issues in biomedical ethics" alt="This courses is itended for anyone who needs a refresher on ethical data handling, Is new working with new data (esp. clinical or genomic data) and wants to use it appropriately, wants to learn about the emerging and current issues in biomedical ethics" width="100%" style="display: block; margin: auto;" />

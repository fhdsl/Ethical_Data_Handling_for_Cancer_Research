...
You likely have heard from your IT department at your institute about being careful about phishing emails. If you are working with PII or PHI, then you need to be extra vigalent. Phising emails are emails in which someone tries to get you to click on a link or to respond with credential information in order to hack your computer or gain access to sensitive data. Criminals are getting more sophisticated in their attempts.
...
Avoid clicking on links in emails where possible. If you must click a link, first  make sure that the link looks like what you would expect. It's also a good idea to send a follow-up fresh email (not a reply) or, communicate using another method (phone, slack, different email address) to make sure the individual actually sent the link instead of a hacker if the link seems out of context. For example, your colleague hasn't told you that he is sending a Google doc link and you receive an email from him with a link that does not look like a Google doc link, then do not click it before verifying that the person really intended to send it.

4) Don't give your credentials in emails! Be careful giving other information.

If someone asks for your credentials be especially concerned. Generally you will not need to share your password with anyone. Typically administrators will have you log in to whatever platform or system you are working in and proceed from there or they will reset your password. If someone asks for your password or username, it is highly likely  a phishing attempt, even if it seems like it is coming from a verified source. For example, let's say the chair of your department suddenly (out of context) asks you for your personal phone number. Before sending this information, contact the chair by other means to make sure this request is legitimate. 
...
See [here](https://www.hipaajournal.com/wp-content/uploads/2015/10/how-to-spot-a-phishing-email-hipaajournal.png) for recommendations on what to look out for form the HIPAA journal.

...
Especially when working with precious data, in case something happens to a computer, drive or even server, it's a good idea to think about storing the data with multiple methods.
...
https://redmondmag.com/articles/2021/12/01/modernizing-the-3-2-1-backup-rule.aspx#:~:text=Backup%20vendors%20often%20try%20to,with%20cloud%20backup%20in%20mind.

...
```{r, fig.align='center', echo = FALSE, fig.alt= "Research often involves collecting personal information about people who participate in research.Personal Identifiable Information (PII) and Protected Health Information (PHI)", out.width="100%"}
...
```{r, fig.align='center', echo = FALSE, fig.alt= "Genomics and Clinical data currently typically pose a higher risk for identification than most imaging data",out.width="100%"}
...
- [Challenges of sharing genomic data](https://www.nature.com/articles/d41586-021-00331-5)

...
```
A comic about why data sharing is important. 
```

## Put your data in repository

Below are some of the standard repositories for data you should consider. For a longer list of repositories, we also advise consulting this [Nature guidance on data repositories](https://www.nature.com/sdata/policies/repositories).

```
A comic with "data available by request of email"
```
...
```
A comic that illustrates the pain of looking at unclear data
```

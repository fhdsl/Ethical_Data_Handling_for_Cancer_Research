...
A variety of reasons emerged that included:
...
- Fear
- Apathy/Dislike
- Restoring Equity, Avoiding Degradation by Others, and Slippery Slope
...
While personality traits were identified, the above reasons suggest that if researchers have more support and are motivated to do quality research instead of attempting to obtain metrics for promotion, perhaps some of these reasons can be mitigated.

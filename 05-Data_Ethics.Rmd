...
The Genetic Information Nondiscrimination Act prohibits employers and health insurance companies from using genetic information to discriminate against indviduals. 
...
This means as researchers we need to keep these data secure and hidden. 

Data types protected under GINA include but arent limited to:
...
For example, thus far RNA-seq data that is summarized and deidentified has been deemed acceptable for public sharing (so long as it has been deidentified), however in the future one could see a scenario in which certain gene expresion patterns could be more solidly determined as indicators of disease. 

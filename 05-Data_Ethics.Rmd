...
Healthcare ethics, and by extension medical research ethics can be described in four pillars (this discussion from @melvin_medical_2020):

### 1. The pillar of beneficence

This pillar means that healthcare and its research must support the wellbeing of the patients. This includes reducing pain and helping to increase their overall quality of life.
...
1996 Health Insurance Portability and Accountability Act (HIPAA) protected health information and identifiable health information must not be shared with anyone outside of certain covered entities without consent. Covered entities include: clinicians, insurance companies, and health care government agencies.
...
GINA is critical to the wellbeing of research participants, however this does not nullify the benefits and necessity of data sharing. Indeed both things are true: genetic data is sensitive and its protection is imperative *but* for research to benefit society and reach cures data sharing is also critical.
